    ...
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      >
        ...
        <div className="col-span-2 grid grid-cols-2 gap-y-3 gap-x-3 mt-3">
          ...
          />
          <select
            className="py-3 px-2 bg-blue-100 text-blue-900 rounded-md"
          ...
          <button className=" flex flex-row items-center justify-center bg-blue-400 col-span-2 py-2 text-white">
            {mutate.isLoading && (
              <svg
